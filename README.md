# Avalanche Token Creation Tool

A simple frontend tool to create tokens on the Avalanche (AVAX) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Avalanche-C-Chain-AVAX-Token-Creation-Tool.git
- And press deploy
- Congrats your Avalanche Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Avalanche-C-Chain-AVAX-Token-Creation-Tool
- Upload into your Github repo.
- Edit the file public/config.json and insert your Avalanche wallet address for receiving fees. Also set fee in AVAX that you want to charge
